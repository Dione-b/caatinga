...
const TRANSIENT_COMMAND_FAILURE_PATTERN =
  /timeout|i\/o timeout|econnreset|connection reset|\b(?:503|502|429)\b|rate limit|temporar|bad gateway|fetch failed|network error|unavailable|tx_?bad_?seq|bad sequence|bad seq/i;
