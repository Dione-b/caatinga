# cli-zk-scaffold Specification

## Purpose

Robustly scaffolding ZK files into a new or existing project, including `--force` merges, without crashing on unrelated project state such as `node_modules` symlinks.
